...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <header className="h-16 bg-base-100 border-b border-base-200 flex items-center justify-between px-4 md:px-6 sticky top-0 z-40 shadow-sm">
      <div className="flex items-center gap-4">
        <button onClick={toggleSidebar} className="md:hidden btn btn-ghost btn-circle btn-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-ghost btn-circle avatar border border-base-200">
            <div className="w-9 rounded-full bg-primary/20 text-primary flex items-center justify-center text-sm font-bold">
              U
            </div>
          </label>
